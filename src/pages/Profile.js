                                    ...
                                    <div className="card-body p-lg-5 p-4 w-100 border-0">
                                        <div className="row">
                                            <div className="col-lg-12">
                                                <h4 className="mb-4 font-xxl fw-700 mont-font mb-lg-5 mb-4 font-md-xs">Profile</h4>
                                                ...
                                                <ul className="list-inline">
                                                    <li className="list-inline-item d-block me-0"><Link to="" onClick={() => localStorage.clear(token)} className="pt-2 pb-2 d-flex align-items-center"> <h4 className="fw-600 font-xsss mb-0 mt-0">Logout</h4></Link></li>
